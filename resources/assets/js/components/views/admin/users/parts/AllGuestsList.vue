        ...
        <section class="mb-5" aria-labelledby="dashboard-current-jury-title">
            ...
            <div class="card mb-3">
                ...
                <ul class="list-group list-group-flush">
                    <li v-for="user in getAvailableGuests" class="list-group-item">
                ...
                <ul class="list-group list-group-flush">
                    <li v-for="user in getUnavailableGuests" class="list-group-item list-group-item-dark">
