        ...
        <section class="mb-5" aria-labelledby="dashboard-current-jury-title">
            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li v-for="student in getAvailableB2" class="list-group-item">
                ...
                <ul class="list-group list-group-flush">
                    <li v-for="student in getUnavailableB2" class="list-group-item list-group-item-dark">
