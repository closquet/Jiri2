        ...
        <section class="mb-5" aria-labelledby="dashboard-current-jury-title">
            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li v-for="student in getAvailableB3" class="list-group-item">
                ...
                <ul class="list-group list-group-flush">
                    <li v-for="student in getUnavailableB3" class="list-group-item list-group-item-dark">
            ...
            <router-link to="/etudiants/ajouter" class="btn btn-primary">Ajouter</router-link> <a href="#" @click.prevent="$router.go(-1)" class="mr-2 mt-2 btn btn-link">Retour</a>
        </section>
    </div>
</template>
